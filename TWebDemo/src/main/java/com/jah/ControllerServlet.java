...
public class ControllerServlet extends HttpServlet {
	...
	private void addLaptop(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException, SQLException {
		...
		System.out.println("adding : " + serial + " " + model + " manufacture " + manufac);
	...
	// create new memo
	private void createMemo(HttpServletRequest request, HttpServletResponse response) throws SQLException, ServletException, IOException {
		...
		dbmodel.createMemo(memoid, serials);
