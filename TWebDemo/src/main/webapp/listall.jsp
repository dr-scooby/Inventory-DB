...
<div class="row">
	...
	<div class="column middle">
		<div class="card">
			...
			<p>Listing all laptops</p>
			<br>
			<p>Un-assigned laptops(on hand): <%= request.getAttribute("onhand") %> </p>
            ...
            <c:forEach var="laps" items="${listlaptops}">
                <tr>
                    <td><c:out value="${laps.serial}" /></td>
                    <td><c:out value="${laps.model}" /></td>
                    <td><c:out value="${laps.manufacture}" /></td>
                    <td><c:out value="${laps.notes}" /></td>
                    <td><c:out value="${laps.assigned}" /></td>
                    <td>
                        <a href="edit?serialid=<c:out value='${laps.serial}' />">Edit</a>
                        &nbsp;&nbsp;&nbsp;&nbsp;
                        <a href="delete?serialid=<c:out value='${laps.serial}' />">Delete</a>                     
                    </td>
                </tr>
            </c:forEach>
        </table>
